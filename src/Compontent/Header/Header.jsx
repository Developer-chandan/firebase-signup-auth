...
const Header = () => {
  ...
  <div className="flex-1">
    <a className="btn btn-ghost normal-case text-xl">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4nKnXI_b_GU0wpcYBkUMjGy8GcBsuliQ3ZvqzQhlcT-NSCL4IJ91H7BMniX48fr-Bh5c&usqp=CAU" className="w-[5rem] h-[2rem]" alt="" />
    </a>

  </div>
  <div className="flex-none gap-2">
    
    <ul className="w-[50rem] mx-auto">
        <Link className="ml-6" to='/'>Home</Link>
        <Link className="ml-6" to='/login'>Login</Link>
        <Link className="ml-6" to='/register'>Register</Link>
        <Link className="ml-6" to='/product'>Products</Link>
    </ul>
